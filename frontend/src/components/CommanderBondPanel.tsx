...
interface GuardianStatusResponse {
  ...
  interventions: Array<{ timestamp: string; level: string; reason: string; stability_score: number; action_taken: string }>;
  last_check: string | null;
}

interface SwordPolicyResponse {
  id: number;
  codename: string;
  name: string;
...
interface YaraScanResultResponse {
  id: number;
  scan_type: string;
  target: string;
  rule_name: string;
...
interface OverwatchIntegrityReport {
  status: string;
  tampered: string[];
  missing: string[];
  new: string[];
